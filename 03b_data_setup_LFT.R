...
table(df$EAVE_LINKNO %in% EAVE$EAVE_LINKNO_old) # 5,142,872 --> suggests EAVE_LINKNO_old should be used
...
Q_raw <- readRDS("/conf/EAVE/GPanalysis/progs/CR/Vaccine/output/temp/Qcovid.rds") # use this version due to problem with diabetes codes in the later version
...
## Impute missing bmi using simd and age data 
### Make simd a factor
